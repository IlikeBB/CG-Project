...
class MLP(nn.Module):
    def __init__(self, num_classes, input_size):
        ...
        self.linear1 = nn.Linear(in_features=input_size, out_features = num_classes)
...
if True:
    ...
    X_train, X_test, y_train, y_test = train_test_split(nii_3t_train, table_label_norm,  stratify=list(table_label_norm['Out_mRS']), test_size=0.25, random_state=123) #seed = 42, 123
    # print(y_train)
...
if True: #model record
    params = {
        ...
        "img size": 384, 
        "img depth": 28,
        "Adjust01": "lr 0.01, CosineAnnealingLR(optimizer, T_max = 100)",
        "fixing": "None"
        }
...
if True: #data augmentation, dataloader, 
    ...
    project_folder = f"TEST12.29-01-223_patient_sum_ONLY_NIHSS_score_22(AP+NL)"
