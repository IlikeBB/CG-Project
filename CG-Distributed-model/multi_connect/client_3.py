...
data = 'Client 3: matrix data data'
matrix_data = {'weight': None}
data_dict = {'status':'echo', 'client 3':matrix_data}
...
while True:
    ...
    model_dict = received_data['client 3']['weight']
    # print(model_dict)
    ...
    # print(weight_dict)
    received_data['client 3']['weight']= weight_dict
