...
data = 'Client 2: matrix data data'
matrix_data = {'weight': None}
data_dict = {'status':'echo', 'client 2':matrix_data}
...
while True:
    ...
    model_dict = received_data['client 2']['weight']
    # print(model_dict)
    ...
    received_data['client 2']['weight']= weight_dict
